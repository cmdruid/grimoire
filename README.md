...
| `inspector` | material review of documents and completed implementations, with an actionable post-verdict fix and re-review close for implementation findings; revise folds supported document findings, refine simplifies specs and plans, and setup deploys Inspector-owned kind doctrine absent-only |
