...
rc=0
for test_file in install-pack-test.sh configure-clankshop-test.sh clankshop-contract-test.sh backlog-anchor-contract-test.sh backlog-provider-contract-test.sh canonical-provider-parity-test.sh; do
  echo "== $test_file"
