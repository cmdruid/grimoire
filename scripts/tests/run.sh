...
rc=0
for test_file in agent-feedback-hard-cut-test.sh configure-clankshop-test.sh clankshop-contract-test.sh backlog-provider-contract-test.sh project-layer-anchor-contract-test.sh canonical-provider-parity-test.sh; do
  echo "== $test_file"
