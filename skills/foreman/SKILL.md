...
| `/foreman calibrate` | `verbs/calibrate.md` | Drain the operational slice of `/backlog`'s dev-experience signal into doctrine / workflow / `AGENTS.md`; classify + dispatch the doc-form / design-seed slices to their stewards (the curation loop) | "calibrate the dev system", "the workflow keeps tripping me" |
