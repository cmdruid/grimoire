...
3. Preview the destination `<agent-workspace>/foreman/operations/<stem>.md` and complete body.
...
4. Put the accepted candidate in ephemeral storage and run package-local
   `scripts/operation-write.sh put --root <root> --workspace <relative> --identity
