...
1. Resolve `<root>` (SKILL.md). Locate `scripts/bug-mint.sh` from this
   skill's own directory.
2. **Mint**: `scripts/bug-mint.sh mint <root> "<symptom, specific>"`. Fill Repro, Expected vs
   actual (paste the real
