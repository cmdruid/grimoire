...
This is `.agents/design/` — the regenerable **seed**. It is the present-tense, standing source of truth
...
`/architect check` fails if any is missing. `.agents/design/src/` holds the compilable per-system specs,
