...
`adr.md` and `specs.md` absent-only beneath `.agents/skilldata/architect/templates/`. Valid
...
creates `.agents/skilldata/architect/drafts/` or `.records/spikes/`; those appear only on an
