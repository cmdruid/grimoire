...
#
# DOCTRINE: identical mechanism to backlog's scripts/register-route.sh, bundled
# here as its own copy -- a self-contained skill directory carries no cross-skill
