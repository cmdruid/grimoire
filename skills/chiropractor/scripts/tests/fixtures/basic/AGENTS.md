...
Bootstrap for agents working on this project.

See [README](README.md) and [dev docs](dev/README.md) for more details.
See [fenced examples](fenced.md) for code-block handling.
