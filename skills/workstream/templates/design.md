...
- **Ground before designing.** Read the project vision doc + the core design principles doc and skim
  ...
  `<project: vision doc, design principles doc, and key invariants -- see host AGENTS.md and the owner-local doctrine it points to>`
...
- **The project keystone is a design tool, not just a constraint.** The foundational architecture
  ...
  of stored?" early.
  `<project: keystone invariant -- see host AGENTS.md and the owner-local doctrine it points to>`
...
- `<project: additional hard-won design lessons -- see host AGENTS.md and the owner-local doctrine it points to>`
