...
Immediate child directories are ignored registered stream worktrees; do not copy or nest them.
Landing follows each stream's compiled policy and synchronizes the clean primary checkout through
the runtime helper's repository lease.
<!-- /workstream:control@1 -->
